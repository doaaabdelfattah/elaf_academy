...
const Faq = () => {
  return (
    <div className="w-[85%] mx-auto my-10 scroll-mt-20" id="faq">
  ...
  <AccordionItem value="item-1" >
    <AccordionTrigger className="lg:text-2xl text-lg">What courses does Elaf Academy offer?</AccordionTrigger>
  ...
  <AccordionItem value="item-2" >
    <AccordionTrigger className="lg:text-2xl text-lg">How can I enroll in a course?</AccordionTrigger>
    <AccordionContent className="text-base  leading-loose">
  ...
  <AccordionItem value="item-3" >
    <AccordionTrigger className="lg:text-2xl text-lg">What are the available class schedules?</AccordionTrigger>
    <AccordionContent className="text-base leading-loose">
  ...
  <AccordionItem value="item-4" >
    <AccordionTrigger className="lg:text-2xl text-lg">How can I contact Elaf Academy for more details?</AccordionTrigger>
    <AccordionContent className="text-base  leading-loose">
